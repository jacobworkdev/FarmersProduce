...
const {createProduce,getAllProduce,deleteProduce,getProduceById, updateProduce,getMyProduce} = require('../controllers/produceController.js')

const router = express.Router();

router.post('/',protect,upload.single('image'),createProduce)
router.get('/',getAllProduce)
router.get('/myproduce',protect,getMyProduce)
